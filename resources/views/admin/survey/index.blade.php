...
<div class="p-4 sm:ml-64">
    <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700">
        <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Survey management</h5>
                    ...
                    <div class="p-6 space-y-6">
                        ...
                        <form action="/admin/survey" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="w-fullpx-3 mb-6 md:mb-0">
                                ...
                                <button type="button" onclick="addQuestion()" class="text-blue-500 text-sm">+ Add
                                    More
                                    Questions</button>
                            </div>
                            <br>

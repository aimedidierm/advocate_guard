...
<body>
    ...
    <section class="relative bg-cover bg-center h-screen" style="background-image: url('/images/hero.jpg');">
        <div
            ...
            <h1 class="text-4xl font-bold relative">{{ __('messages.landingpage.advocateguard') }}</h1>
            <h2 class="text-xl font-bold relative">
                {{__('messages.landingpage.children-right') }}
            </h2>
        </div>
    </section>

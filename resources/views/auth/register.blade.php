    ...
    <section class="bg-gray-50 dark:bg-gray-900">
        <div class="flex flex-col items-center justify-center min-h-screen bg-cover bg-center"
            ...
            <div class="text-center mb-10">
                <h1 class="text-4xl font-extrabold text-white dark:text-white sm:text-5xl md:text-6xl">
                  {{ __('messages.register.welcomeTitle') }} 
                </h1>
                <h2 class="mt-4 text-lg font-medium text-white dark:text-gray-300 sm:text-xl">
                    ...
                    <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <form class="space-y-4 md:space-y-6" action="/auth/register" method="POST">
                            ...
                            <div class="flex space-x-4">
                                ...
                                <div class="w-1/3">
                                    <label for="id_number"
                                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">{{ __('messages.register.passport') }}</label>
                            ...
                            <div class="flex space-x-4">
                                ...
                                <div class="w-1/3">
                                    <label for="country"
                                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">{{ __('messages.register.country') }}</label>
                                ...
                                <div class="w-1/3">
                                    <label for="address"
                                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">{{ __('messages.register.address') }}</label>
